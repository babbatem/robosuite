...
class SlideCIP(SingleArmEnv, CIP):
    """
    ...
    def _load_model(self):
        ...
        if self.placement_initializer is not None:
            ...
            self.placement_initializer.add_objects(self.slide)
        else:
    ...
    def _setup_references(self):
        ...
        self.hinge_qpos_addr = self.sim.model.get_joint_qpos_addr(self.slide.joints[0])
    ...
    def _setup_observables(self):
        ...
        if self.use_object_obs:
            ...
            sensors = [slide_pos, handle_pos, slide_to_eef_pos, handle_to_eef_pos, hinge_qpos]
    ...
    def _reset_internal(self):
        ...
        if not self.deterministic_reset:
            ...
            slide_pos = (-0.6, -0.5, 0.8)
            slide_quat = [0.70710678,  0.,  0., -0.70710678]
