...
from robosuite.models.objects import MonkeyBoxTwoObject
...
class SliderBoxCIP(SingleArmEnv, CIP):
    """
    """
    ...
    def _setup_observables(self):
        ...
        if self.use_object_obs:
            ...
            sensors = [box_pos, top_handle_pos, slide_handle_pos, 
                       box_to_eef_pos, top_handle_to_eef_pos, slide_handle_to_eef_pos, 
                       top_hinge_qpos, slide_hinge_qpos]
